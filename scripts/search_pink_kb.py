...
kb.parse('graphs/pink-agents.ttl') # agents
kb.parse('graphs/googlespreadsheet_resources.ttl') # All the resources
kb.parse('graphs/datamodels.ttl') # datamodels
...
kb.serialize('graphs/everything.ttl', format='turtle')
