...
| :Object          | The class of all individuals who's temporal parts are of the same type as the whole. | |
...
| :Datum           | A self-consistent encoded data entity. | Datum are the building blocks of datasets. |
...
| :Participant | An object which is a spatial part of a process. | Example: A student during an examination. |
