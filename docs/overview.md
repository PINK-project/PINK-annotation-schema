...
The PINK Annotation Schema is by itself not a top-level ontology, but is strives to be easy to align with different top-level ontologies, like [EMMO] and [BFO].
...
- Reference documentation:
  - For the [PINK Annotation Schema]
  - For [reused terms]
...
[Class-level documentation]: ./background.md#class-level-documentation
